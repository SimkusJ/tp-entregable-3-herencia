...
class Viaje
{
    ...
    private $codigoViaje;
    private $montoActual;
    private $costoDelPasaje;

    public function __construct($codigoViaje, $destino, $responsable, $cantidadMaxima, $costoDelPasaje, $pasajero)
    {
    ...
    //Costo del pasaje
    public function setCostoDelPasaje($costo)
    {
        $this->costoDelPasaje = $costo;
    }
    public function getCostoDelPasaje()
    {
        return $this->costoDelPasaje;
    }
    ...
    public function venderPasaje($pasajero)
    {
        ...
        if ($this->hayPasajesDisponible()) {
            ...
            $costo = $this->getCostoDelPasaje();
            $incremento = $costo * ($pasajero->darPorcentajeIncremento / 100);
